...
public class HolidayBonusTest {
	...
	public void testCalculateTotalHolidayBonusA() {
		...
		assertEquals(29000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 5000, 1000, 2000),.001);
	...
	public void testCalculateTotalHolidayBonusB() {
		...
		assertEquals(6250.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 1000,250,500),.001);
